# Contributing to fairpub

First off, thanks for taking the time to contribute to `fairpub`!
...
Conduct](https://github.com/FRBCesab/fairpub/blob/main/CODE_OF_CONDUCT.md).
By contributing to this project, you agree to abide by its terms.

## Style guide

We use the [Tidyverse style guide](https://style.tidyverse.org/) for
writing R code. You can install [air](https://github.com/posit-dev/air)
to automatically format your R code. Functions are documented with the
[roxygen2](https://roxygen2.r-lib.org/articles/roxygen2.html) syntax.
`fairpub` uses the `lower_snake_case`.
...
[Issues](https://github.com/frbcesab/fairpub/issues) that might help
...
- Open a new [Issue](https://github.com/frbcesab/fairpub/issues/new).
- Use the template
  [other_issue.md](https://github.com/frbcesab/fairpub/blob/master/.github/ISSUE_TEMPLATE/other_issue.md).
...
- Make sure that you are using the latest version of `fairpub`.
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/frbcesab/fairpub/issues?q=label%3Abug).

### How do I submit a bug report?

We use [GitHub Issues](https://github.com/frbcesab/fairpub/issues) to
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/frbcesab/fairpub/issues/new).
- Use the template
  [bug_report.md](https://github.com/frbcesab/fairpub/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `fairpub`.
- Read the [documentation](https://github.com/frbcesab/fairpub/)
  carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/frbcesab/fairpub/issues) to see
  if this enhancement has already been suggested. If it has, add a
  comment to the existing issue instead of opening a new one.

### How do I submit a feature request?

Feature requests are tracked as [GitHub
Issues](https://github.com/frbcesab/fairpub/issues).

- Open a new [Issue](https://github.com/frbcesab/fairpub/issues/new).
- Use the template
  [feature_request.md](https://github.com/frbcesab/fairpub/blob/master/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the
  suggestion.
- Provide a step-by-step description of the suggested enhancement in as
  many details as possible.
- Explain why this enhancement would be useful to most `fairpub` users.
...
2.  [Clone](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
    ...
    of your fork). Alternatively, open RStudio IDE or Positron IDE and
...
7.  Submit a [Pull
    ...
    on the [original repo](https://github.com/frbcesab/fairpub/compare).
