...
impact factor. This method is implemented in the `fp_compute_citation_ratio()` function 
...
The `fp_compute_citation_ratio()` function can also be used to answer the question 
