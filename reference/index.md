...
## Fairness & Citation ratio

Functions to retrieve tha fairness status of an article/journal and to
compute the citation ratio of a list of articles.
...
Helpers related to the DAFNEE database.
